# -*- coding: utf-8 -*-
"""第42轮 · 跑 conn42b.csx（指定章；只 load + -s，不落盘 data.win）
...
SRC = r'E:\Download\_tmp\conn42b.csx'
...
dst = os.path.join(sdir, 'conn42b.csx')
...
fp = os.path.join(W, 'conn42b.json')
print('  conn42b.json  %s' % (('%d B' % os.path.getsize(fp)) if os.path.isfile(fp) else '(缺)'))
