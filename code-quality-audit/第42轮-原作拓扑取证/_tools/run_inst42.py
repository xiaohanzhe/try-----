# -*- coding: utf-8 -*-
"""第42轮 · 跑 inst42.csx（指定章；只 load + -s，不落盘 data.win）
...
SRC = r'E:\Download\_tmp\inst42.csx'
...
dst = os.path.join(sdir, 'inst42.csx')
...
fp = os.path.join(W, 'inst42.json')
print('  inst42.json  %s' % (('%d B' % os.path.getsize(fp)) if os.path.isfile(fp) else '(缺)'))
