...
ANIMATION_METADATA = {
    ...
    # ===== 情绪表达类动作（由AI根据对话场景判断是否播放，不随机触发）=====
    "surprised": (1, 0.03, "表情", ["surprised", "shocked"],
                "惊讶，单帧，对话中听到意外消息或被吓到的时候用"),
    "cower":   (1,  0.03, "表情", ["fear", "scared"],
                "害怕地缩起来，单帧，感到恐惧或不安的时候用，不要频繁用"),
    "cry":     (2,  0.07, "表情", ["sad", "heartbroken"],
                "哭，2帧，非常难过或感动到哭的时候用，不要频繁用"),
    "kneel_cry": (2, 0.07, "表情", ["sad", "devastated"],
                "跪下哭，2帧，极度悲伤时才用，非常强烈的情绪表达，极少使用"),
    "kneel_serious": (1, 0.03, "表情", ["serious", "respectful"],
                "严肃地跪下，单帧，郑重道歉或认真表态的时候用"),
}
...
_ACTION_SYSTEM_PROMPT = (
    ...
    "- surprised：1帧/瞬间，惊讶，听到意外消息或被吓到时用\n"
    "- cower：1帧/瞬间，害怕缩起来，感到恐惧不安时用，不要频繁用\n"
    "- cry：2帧/0.07秒，哭，非常难过或感动时用，不要频繁用\n"
    "- kneel_cry：2帧/0.07秒，跪下哭，极度悲伤时才用，极少使用\n"
    "- kneel_serious：1帧/瞬间，严肃跪下，郑重道歉或认真表态时用\n\n"
    "其他动作：\n"
