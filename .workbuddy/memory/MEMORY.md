...
## 10. 历轮索引（**详版 §14–§47 有完整版** + 各轮报告）**26–46**：H4H5／AI 失真／场景 P0／路由／首字／7B／结巴／移动严查／素材反编译／1,013 场景+P0 接线／真背景 157／40 注入上限／41 原作复现取证／42 门机制+五章拓扑／43 换房+相机平移／44 对话框复刻+渲染层+路由 v2+objects+动效／45 场景自主寻路（§46）／**46 原作系统通读（四套机制）+ 伙伴交互框架 P0~P2（§47）**。
`8f95f5e` `21b520d` `7b9d10a` `8824e81` `555c797`（38~39 全表见详版 §41.10）

## 11. 🔴 待用户裁定（**全文见详版 §36.8/§37.11/§39.10/§40.8/§43.6/§44.8/§45.9/§46.10/§47.11**）
